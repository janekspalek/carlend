                                ...
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white">';
                                        ...
                                        if(!mysqli_real_connect($pripojeni, $server, $uzivatel, $heslo, $db)) {
                                            ...
                                            $sql = "SELECT * FROM rezervace WHERE uzivatel = " . $_SESSION["id"] . " ORDER BY id_r DESC";
                                            ...
                                            if(mysqli_num_rows($seznamRezervaci) > 0) {
                                                while (($rezervace = mysqli_fetch_array($seznamRezervaci)) != NULL) {
                                                    ...
                                                    <tr class="text-gray-800 hover:bg-gray-100 transition-all">
                                                        ...
                                                        <td class="px-4 py-3 text-sm font-semibold border">' . $vozidlo["nazev"] . '</td>
                                                        ...
                                                        <td class="px-4 py-3 border">
                                                            <div class="flex justify-center">
                                                                <a href="moje-rezervace-smazani.php?rezervace=' . $rezervace["id_r"] . '" class="mr-5 cursor-pointer">
                                                                    <i class="ri-delete-bin-6-fill text-2xl transition-all hover:text-red-500"></i>
                                                                </a>
                                                                <a href="moje-rezervace-edit.php?rezervace=' . $rezervace["id_r"] . '" class="cursor-pointer">
                                                ...
                                                echo "Momentálně nemáte ještě žádné rezervace.";
                                            }
                                        }
                                        echo '
                                    </tbody>
